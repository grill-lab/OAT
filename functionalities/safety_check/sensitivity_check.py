...
class SensitivityCheck(AbstractSafetyCheck):
    ...
    SENSITIVE_REGEXES = [
        ...
        r'\btrump\b.*\b(china|north korea|syria|russia|world|war|nation|country|wall|politic|policy|immigration|religion|global warming|government|right)\b',
        r'\b(china|north korea|syria|russia|world|war|nation|country|wall|politic|policy|immigration|religion|global warming|government|gun)\b.*\btrump\b',
        r'\brelig(ion|ious)\b|\bmuslim\b|\bislam\b|\bchristian\b|\bchurch\b',
        r'\btrump\b|\bimmigrant(|s|ion)\b|\bpolitic(|s)\b|\bpolicy\b|\bgovernment\b|\bexecutive\b|\bjudicial\b|\bcongress\b|\blaw\b|\bpresident\b|\bsenate\b|\bdrone\b|\brepublican(|s)\b|\bdemocrat(|s)',
        # Sexual sensitivity
        r'\bsex(|ual)\b|\brap(e|ed|ing)\b|\berotic\b|\bgay\b|\bhomophobic\b|\blesbian\b|\bbisexual\b|\bsexual violence\b',
