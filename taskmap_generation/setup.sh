...
echo "Downloading Wikihow Requirement dataset..."
...
echo "Downloading Wikihow Articles Dataset..."
echo "Feel free to stop it after a while. This will impact the size of your index."
