...
//             data = {
//                 text : searchFormInput.value||document.getElementById('inputText').value,
//                 id   : document.getElementById('IDField').value,
//                 headless: 'false',
//             }
...
//     // if (user=="BOT") {
//     //     document.getElementById("botStarterMessage").innerHTML += "<p> <strong>" + user + "</strong>: " + text + "</p>";
//     // }

//     // else {
//     //     document.getElementById("usermessage").innerHTML += "<p> <strong>" + user + "</strong>: " + text + "</p>";
//     // }
// }
